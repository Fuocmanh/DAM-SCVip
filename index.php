					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="about.php">Tìm hiểu</a></li>
								<li><a href="#">Trang liên hệ</a>
									<ul class="sub-menu">
										<li><a href="404.php">404 page</a></li>
										<li><a href="about.php">Tìm hiểu về chúng tôi</a></li>
										<li><a href="cart.php">Giỏ hàng</a></li>
										<li><a href="checkout.php">Thanh toán</a></li>
										<li><a href="contact.php">Liên hệ</a></li>
										<li><a href="news.php">Tin tức</li>
										<li><a href="shop.php">Cửa hàng</a></li>
									</ul>
								</li>
								<li><a href="news.php">Tin tức</a>
									<ul class="sub-menu">
										<li><a href="news.php">Tin tức chính</a></li>
										<li><a href="single-news.php">Tin tức trong ngày</a></li>
									</ul>
								</li>
								<li><a href="contact.php">Liên hệ</a></li>
								<li><a href="shop.php">Cửa hàng</a>
									<ul class="sub-menu">
										<li><a href="shop.php">Cửa hàng</a></li>
										<li><a href="checkout.php">Thanh toán</a></li>
										<li><a href="single-product.php">Sản phẩm đơn lẻ</a></li>
										<li><a href="cart.php">Giỏ hàng</a></li>
									</ul>
								</li>
								<li>
